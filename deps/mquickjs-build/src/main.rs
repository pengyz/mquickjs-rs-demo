...
fn build_cmd(argv: Vec<String>) {
    ...
    // If an aggregated umbrella header is provided, also copy the corresponding
    // mquickjs_ridl_api.h sibling. Otherwise write empty stubs.
    if let Some(src) = &ridl_register_h {
        ...
        .expect("write empty mquickjs_ridl_register.c");
    }
